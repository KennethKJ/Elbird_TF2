...
with tf.Session() as sess:
    ...
    if 'ML-MAIN' == os.environ['COMPUTERNAME']:
        model_dir = "C:/Users/alert/Google Drive/ML/ElBird/saved model/1569283987/"
    else:
        model_dir = "C:/EstimatorOutput/37/saved model/1569283987/"
    ...
    doBooth = True
    for i in range(100):  # 2158

        if doBooth:

            dB_loc = "C:/Users/alert/Google Drive/ML/Databases/Photo Booth User Group Photos/(2) Bird Photo Booth Users Group_files/"
            dB_loc = "C:/Users/alert/Google Drive/ML/Own Feeder BirdPics/"
            dB_loc = "C:/Users/alert/Google Drive/ML/Databases/Attricting Wild Birds to your yard FB group/(4) Attracting Wild birds to your Yard..Bird-feeders and Birdhouses_files/"
        ...
        ax.imshow(im)
        plt.title(classes[pred] + ' with ' + str(np.round(np.max(Y)*100)) + '% certainty')
        plt.show()
        print(classes[pred])
        print("BOSSE!")
